...
class HomeHead extends Head
{
    public function __construct(array $chilldrens = [], ?string $title = "Evoluciona tu Bio Link en una Bio Landing" )
    {
        parent::__construct(array_merge(
            ...
            new Link(['rel' => 'preconnect', 'href' => 'https://fonts.gstatic.com', 'crossorigin' => 'anonymous']),
            new Link(['rel' => 'stylesheet', 'href' => 'https://fonts.googleapis.com/css2?family=Inter:ital,opsz,wght@0,14..32,100..900;1,14..32,100..900&family=Rajdhani:wght@300;400;500;600;700&family=Rubik:ital,wght@0,300..900;1,300..900&family=Space+Grotesk:wght@300..700&display=swap']),
